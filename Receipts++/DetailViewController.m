...
- (void)configureView {
    ...
    if (self.receipt) {
        ...
        self.amountTextField.text = [[self.receipt valueForKey: @"amount"] description];
        self.detailsTextField.text = [[self.receipt valueForKey: @"descript"] description];
        self.timeStampLabel.text = stringFromDate;
        self.changeTitleTextField.text = [[self.receipt valueForKey:@"title"] description];
    }
}
...
- (IBAction)saveData:(id)sender {
    ...
    self.receipt.title = self.changeTitleTextField.text;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"addLabels"]) {
//        LabelsViewController *labelsController = [[LabelsViewController alloc] init];
        [[segue destinationViewController] setReceipt:self.receipt];
        [self.navigationController popViewControllerAnimated:YES];
...
//    
//    fetchRequest.predicate = [NSPredicate predicateWithFormat:@"receipt contains %@", self.label.labelName];
...
////    
////    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.label.managedObjectContext sectionNameKeyPath:nil cacheName:self.label.labelName];
////    
